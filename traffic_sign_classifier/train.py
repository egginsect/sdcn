...
from model import LeNet, VGG16, VGGsimple
import argparse
...
parser.add_argument('--num_epoch', default=100, help='Number of epochs', type=int)
...
parser.add_argument('--keep_prob', default=0.5, help='Keep probability for dropout', type=int)
config = parser.parse_args()
trainBG = BatchGenerator(X_train, y_train, config.batch_size, 'train')
validBG = BatchGenerator(X_valid, y_valid, config.batch_size)
testBG = BatchGenerator(X_valid, y_valid, config.batch_size)
