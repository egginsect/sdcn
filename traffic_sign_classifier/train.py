...
parser.add_argument('--num_epoch', default=200, help='Number of epochs', type=int)
...
parser.add_argument('--grayscale', default=False, help='Using data augmentation', type=int)
parser.add_argument('--keep_prob', default=0.7, help='Keep probability for dropout', type=int)
