...
parser.add_argument('--num_epoch', default=300, help='Number of epochs', type=int)
...
parser.add_argument('--keep_prob', default=.9, help='Keep probability for dropout', type=int)
